          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box" style=" outline:none; border-radius:20px 20px 20px 20px ; border:transparent;">
                ...
                <div class="box-body">
                     <p><span style="color:RED; font-size:20px;"><b>NOTE:  </b></span>  The message that you're about to compose will be sent to all the members once you have clicked the <span style="color:blue;">Send Now</span> button below.  </p>
                     <hr>
