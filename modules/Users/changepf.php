...
<form enctype="multipart/form-data" style="outline:none; box-shadow:0px 2px 2px 1px #777; outline:none; border-radius:50px 50px ; border: solid #000; width:600px; padding:20px;" method="post">
                        ...
                        <h3 align="left" style="color:darkblack;"><center>Update Gambar Profil </center></h3>
                        <br>
...
?>
                        ...
                        <input type="file" class="form-control" type="file" name="image"  id="file" required/><br/>
                         <button  style="outline:none; border-radius:50px 50px ; color:black" type="submit" name="uploadf" class=""><span class="glyphicon glyphicon-circle-arrow-up"></span> Update Profile Picture</button>
