        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">MS Excel List</li>
          </ol>
        </section>
        <hr>
          ...
          <div class="row">
              ...
              <div class="box" style=" outline:none; border-radius:20px 20px 20px 20px ; border:transparent;">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <?php 
              $mydb = mysql_query("SELECT * FROM msexcel ORDER BY id DESC");
            ...
            ?>
                    ...
                    <br>
                    <div class="pull-left">
                     <a style="background:#0a0;color:white; box-shadow:0px 2px 2px 1px #777; outline:none; border-radius:50px 50px ;" href="index.php?view=add" class="btn btn-default"><span class="glyphicon glyphicon-upload -sign"></span> Upload MS Excel File</a>
        
                

        <?php
        $status = mysql_query("SELECT COUNT(ID)as countid FROM msexcel");
