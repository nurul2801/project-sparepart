        ...
        <section class="content-header" >
          <h1>
            Upload MS PowerPoint Files  
            <small>Control Panel</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Upload MS PowerPoint File</li>
          </ol>
        </section>
 <hr>
...
<div style="position:relative; width:1000px; margin:1em auto; padding:5px; background-color: #ffffff;" class="table-bordered">
 ...
 <div class="banner" style="width:100%;" >
 	<div style="width:100%;	height:100px; margin:1px auto; background-color:rgb(235, 163, 20);	background-image:url('banner/banner.png');	background-repeat: no-repeat;"></div>	
 </div>	
